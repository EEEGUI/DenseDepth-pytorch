...
def fill_depth_colorization_fpf(imgRgb=None, imgDepthInput=None, alpha=1):
    t0 = time.time()
    imgIsNoise = imgDepthInput == 0
    maxImgAbsDepth = np.max(imgDepthInput)
    imgDepth = imgDepthInput / maxImgAbsDepth
...
if __name__ == '__main__':
    ...
    a = fill_depth_colorization_fpf(rgb_img, depth_img)
